...
<script type="text/javascript">
	...
	function del() {
		...
		form1.action = "userOrderDelete.action";
		form1.submit();
	}
</script>
<body>
		...
		<table>
			...
			<s:iterator id="temporder" value="orderList">
				<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#d4e3e5';">
					...
					<td align="center">${temporder.train.departure}</td>
					<td align="center">${temporder.train.arrive}</td>
					<td align="center">${temporder.train.starttime}</td>
	...
	<input type="button" value="回主页" onclick="javascript:window.location.href='gouser.action'" />
</body>
</html>
